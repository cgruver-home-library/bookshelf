...
APP_NAME=bookshelf
GIT_REPOSITORY=https://github.com/lab-monkeys/bookshelf.git
CONFIG_GIT_REPOSITORY=https://github.com/lab-monkeys/bookshelf.git
CONFIG_GIT_BRANCH=main
CONFIG_GIT_PATH=/bookshelf/okd-config/dev
